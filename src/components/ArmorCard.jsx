...
export const ArmorCard = ({ armorData }) => {
    return (
        <li className="w-full sm:w-96 flex flex-col rounded-lg text-center shadow items-center justify-center relative p-2 pt-4 rounded-xl border-2 border-neutral-800">
